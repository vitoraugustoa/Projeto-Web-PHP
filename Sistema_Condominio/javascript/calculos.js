  $("tbody tr").each(function(){
    ...
    var resultadoCondominio = (parseFloat(cemig)  +  parseFloat(copasa) + parseFloat(limpeza)) / parseFloat(divide);
    var resultadoDispesas =  (parseFloat(tarifa_bancaria) + parseFloat(outros)) / parseFloat(divide);
